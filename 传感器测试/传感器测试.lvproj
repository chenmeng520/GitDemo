...
<Project Type="Project" LVVersion="21008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="多路分流器测试.vi" Type="VI" URL="../多路分流器测试.vi"/>
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="2700电流加载及换向回读.vi" Type="VI" URL="../电流换向/2700电流加载及换向回读.vi"/>
			<Item Name="CAN Read.vi" Type="VI" URL="../can驱动/VIs/CAN Read.vi"/>
			<Item Name="CAN type.ctl" Type="VI" URL="../can回读/CAN type.ctl"/>
			<Item Name="PCANBasic.dll" Type="Document" URL="../can驱动/PCANBasic.dll"/>
			<Item Name="PCANBasic.lvlib" Type="Library" URL="../can驱动/PCANBasic.lvlib"/>
			<Item Name="报文解析.vi" Type="VI" URL="../报文解析/报文解析.vi"/>
			<Item Name="多通道CAN FD回读.vi" Type="VI" URL="../can回读/多通道CAN FD回读.vi"/>
			<Item Name="多通道CAN 回读.vi" Type="VI" URL="../can回读/多通道CAN 回读.vi"/>
			<Item Name="精度判定.vi" Type="VI" URL="../精度判定/精度判定.vi"/>
		</Item>
